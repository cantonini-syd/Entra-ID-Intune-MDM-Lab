...
![Create user - Jane Doe](images/02-create-user-jdoe.png)
![Create user - John Smith](images/03-create-user-jsmith.png)
...
![Conditional Access - MFA grant control](images/07-ca-policy-mfa-grant.png)
![Conditional Access policy list](images/08-ca-policies-list.png)
...
![Intune tenant status - MDM authority](images/09-intune-mdm-authority.png)
...
![Apple enrollment prerequisites](images/10-apple-enrollment-prerequisites.png)
...
![Installing management profile](images/13-enrollment-install-profile.png)
![Enrollment success](images/14-enrollment-success-registered.png)
![Device enrolled in Intune](images/15-device-enrolled.png)
...
![Compliance policy settings](images/16-compliance-policy-settings.png)
![Compliance policy assignments](images/17-compliance-policy-assignments.png)
![Compliance policy review and create](images/18-compliance-policy-review-create.png)
...
![Configuration profile - PIN requirement](images/19-configuration-profile-pin.png)
...
![Device compliance status - Compliant](images/21-device-compliance-status.png)
...
![Conditional Access - require compliant device](images/22-ca-policy-compliant-device-grant.png)
![Conditional Access policy details](images/23-ca-policy-compliant-device-details.png)
